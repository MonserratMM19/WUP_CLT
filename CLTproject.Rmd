...
The graph is looking more symmetrical, because now we are using 23 samples at a time which gives for more chances for opinion discrepancies. and the standard deviation is decreasing as expected becuse we are dividing by a larger number. in this case it's the square root of 24 
