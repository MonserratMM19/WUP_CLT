...
```
The graph is looking more symmetrical because now we are using 36 samples at a time which gives more chance for opinion discrepancies. and the standard deviation is decreasing as expected because we are dividing by a larger number in this case it's the square root of 36. this graph, in addition to the previous ones, demonstrated the central limit theorem by showing standard deviation as we increase the sample size. 
